...
<header class="navbar" id="navbar">
  <nav class="nav-container">
    <a href="#home" class="logo">Ali<span>Hassan</span></a>
...
<section class="hero" id="home">
  ...
  <div class="hero-container">
    <div class="hero-text reveal-up">
      ...
      <h1>Hi, I'm <span class="gradient-text">Ali Hassan</span></h1>
      <h2 class="typed-wrap">I'm a <span id="typed"></span><span class="cursor-blink">|</span></h2>
      <p class="hero-desc">
        I design and build clean, fast, and reliable websites — from pixel-accurate
        front-ends to PHP-powered back-ends. I care about the small details that make
        an interface feel premium, and the solid code that keeps it running.
      </p>

      <div class="hero-buttons">
        <a href="assets/cv/Ali-Hassan-CV.pdf" class="btn btn-primary ripple" download>Download CV</a>
        <a href="#contact" class="btn btn-secondary ripple">Hire Me</a>
      </div>

      <div class="social-icons">
        <a href="https://github.com/alohussan1-cloud" target="_blank" rel="noopener" aria-label="GitHub" class="social-icon">
    ...
    <div class="hero-visual reveal-up delay-15">
      <div class="avatar-ring">
        <div class="avatar-glow"></div>
        <img src="ProfilePic.jpg" alt="Portrait of Ali Hassan" loading="lazy" class="avatar-img">
      </div>
      <div class="floating-chip chip-1">&lt;/&gt; PHP</div>
      <div class="floating-chip chip-2">JavaScript</div>
      <div class="floating-chip chip-3">Responsive UI</div>
    </div>
  </div>
...
<section class="skills" id="skills">
  <div class="section-container">
    <p class="section-eyebrow center">My Toolkit</p>
    <h2 class="section-title center">Skills &amp; Technologies</h2>
    <p class="section-sub center">The languages and tools I use to design, build, and ship.</p>

    <div class="skills-grid">

      <div class="skill-card reveal-up">
        <div class="skill-icon icon-html">
          <svg viewBox="0 0 24 24"><path d="M3 2h18l-1.6 18L12 22l-7.4-2L3 2Zm14.8 5.1H8l.2 2.1h9.4l-.6 6.7-4.9 1.4-5-1.4-.3-3.1h2.1l.15 1.5 3.05.8 3-.8.3-3.2H7.2l-.5-5.9h11.4l-.3 2Z"/></svg>
        </div>
        <h3>HTML5</h3>
        <div class="progress-track"><div class="progress-fill" data-percent="95"></div></div>
        <span class="progress-label">Expert</span>
      </div>

      <div class="skill-card reveal-up delay-05">
        <div class="skill-icon icon-css">
          <svg viewBox="0 0 24 24"><path d="M3 2h18l-1.6 18L12 22l-7.4-2L3 2Zm4.7 6.9.2 2.1h8.4l-.3 3-3 .8-3-.8-.2-1.9H7.7l.3 3.7 4 1.1 4-1.1.6-6.3H8.6l-.1-1.5h8.9l.2-2H7.4l.3 3.9Z"/></svg>
        </div>
        <h3>CSS3</h3>
        <div class="progress-track"><div class="progress-fill" data-percent="93"></div></div>
        <span class="progress-label">Expert</span>
      </div>

      <div class="skill-card reveal-up delay-10">
        <div class="skill-icon icon-js">
      ...
      <div class="skill-card reveal-up delay-15">
        <div class="skill-icon icon-php">
      ...
      <div class="skill-card reveal-up delay-20">
        <div class="skill-icon icon-mysql">
      ...
      <div class="skill-card reveal-up delay-30">
        <div class="skill-icon icon-github">
          <svg viewBox="0 0 24 24"><path d="M12 .5C5.73.5.98 5.24.98 11.52c0 4.92 3.19 9.09 7.62 10.56.56.1.76-.24.76-.54v-2.1c-3.1.68-3.76-1.31-3.76-1.31-.5-1.28-1.24-1.62-1.24-1.62-1.02-.7.08-.68.08-.68 1.13.08 1.72 1.16 1.72 1.16 1 1.72 2.63 1.22 3.27.93.1-.73.39-1.22.71-1.5-2.48-.28-5.08-1.24-5.08-5.5 0-1.22.44-2.21 1.15-2.99-.11-.28-.5-1.42.11-2.96 0 0 .95-.3 3.1 1.14a10.7 10.7 0 0 1 5.64 0c2.15-1.44 3.1-1.14 3.1-1.14.61 1.54.22 2.68.11 2.96.72.78 1.15 1.77 1.15 2.99 0 4.27-2.6 5.21-5.09 5.49.4.35.76 1.03.76 2.08v3.08c0 .3.2.65.77.54 4.42-1.47 7.6-5.64 7.6-10.56C23.02 5.24 18.27.5 12 .5Z"/></svg>
        </div>
        <h3>GitHub</h3>
        <div class="progress-track"><div class="progress-fill" data-percent="40"></div></div>
      ...
      <div class="skill-card reveal-up delay-35">
        <div class="skill-icon icon-rest">
      ...
      <div class="skill-card reveal-up delay-40">
        <div class="skill-icon icon-responsive">
          <svg viewBox="0 0 24 24"><path d="M4 4h7v7H4V4Zm9 0h7v4h-7V4Zm0 6h7v10h-7V10ZM4 13h7v7H4v-7Z"/></svg>
        </div>
        <h3>Responsive Design</h3>
        <div class="progress-track"><div class="progress-fill" data-percent="90"></div></div>
        <span class="progress-label">Expert</span>
      </div>
...
<section class="services" id="services">
  <div class="section-container">
    <p class="section-eyebrow center">What I Do</p>
    <h2 class="section-title center">Services</h2>
    <p class="section-sub center">Focused help for the front-end and back-end work your project actually needs.</p>

    <div class="services-grid">
      <div class="service-card reveal-up">
        <div class="service-icon">
          <svg viewBox="0 0 24 24"><path d="M8 4 2 12l6 8M16 4l6 8-6 8M14 3l-4 18"/></svg>
        </div>
        <h3>Frontend Development</h3>
        <p>Responsive, accessible interfaces built with clean semantic HTML and modern CSS — pixel-accurate and fast on every screen.</p>
      </div>
      <div class="service-card reveal-up delay-10">
        <div class="service-icon">
          <svg viewBox="0 0 24 24"><path d="M4 6h16v4H4V6Zm0 6h10v8H4v-8Zm12 0h4v8h-4v-8Z"/></svg>
        </div>
        <h3>PHP Web Development</h3>
        <p>Dynamic PHP &amp; MySQL back-ends: authentication, dashboards, and small e-commerce systems built on solid, secure foundations.</p>
      </div>
      <div class="service-card reveal-up delay-20">
        <div class="service-icon">
          <svg viewBox="0 0 24 24"><path d="M12 2 3 6v6c0 5 4 9 9 10 5-1 9-5 9-10V6l-9-4Zm0 5 2 4 4 .5-3 3 .8 4.3L12 16l-3.8 2.8L9 14.5l-3-3 4-.5 2-4Z"/></svg>
        </div>
        <h3>Website Maintenance</h3>
        <p>Bug fixes, performance tuning, and incremental improvements to keep an existing site fast, secure, and up to date.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="projects" id="projects">
  <div class="section-container">
    <p class="section-eyebrow center">Recent Work</p>
...
<footer class="footer">
  <div class="section-container footer-grid">
    <div class="footer-brand">
      <a href="#home" class="logo">Ali<span>Hassan</span></a>
      <p>Frontend &amp; PHP developer building clean, modern web experiences.</p>
    </div>
  ...
  <div class="footer-bottom">
    <p>&copy; <span id="year"></span> Ali Hassan. All rights reserved.</p>
  </div>
</footer>
